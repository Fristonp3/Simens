...
static const struct {
    ...
    {BOARD_KEY_WAKE_CLK, (uint32_t)BOARD_KEY_WAKE_PORT, BOARD_KEY_WAKE_PIN, BOARD_KEY_WAKE_EXTI, EXTI_SOURCE_GPIOA, BOARD_KEY_WAKE_IRQN},
    {BOARD_KEY_MODE_CLK, (uint32_t)BOARD_KEY_MODE_PORT, BOARD_KEY_MODE_PIN, BOARD_KEY_MODE_EXTI, EXTI_SOURCE_GPIOC, EXTI10_15_IRQn},
    {BOARD_KEY_NEXT_CLK, (uint32_t)BOARD_KEY_NEXT_PORT, BOARD_KEY_NEXT_PIN, BOARD_KEY_NEXT_EXTI, EXTI_SOURCE_GPIOE, EXTI3_IRQn}
};
